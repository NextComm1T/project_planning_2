...
/**
 * 고지 카드 하나(디자인 L547 · L551 · L555 · L559).
 * 회색 소제목 + 본문. 네 장이 같은 모양이라 여기서 한 번만 그린다.
 *
 * NOTE: 가입 단계의 동의 상세 화면(#38 · L136-167)과 본문이 거의 같다.
 * 합치려면 `components/shared/` 또는 상수 파일로 올리는 **별도 PR** 이어야 해서
 * (이슈 #49 「참고」) 이 브랜치에서는 화면 폴더 안에 둔다.
 */
...
/** 문단 본문(디자인 L557 · L561 — `15/500 line-height 1.65`). */
...
/**
 * 가운뎃점으로 시작하는 목록(디자인 L549 · L553 — `15/500 line-height 1.9`).
 *
